...
SOLR_SSL_KEY_STORE=/var/solr/certs/biztek.co.id.jks
SOLR_SSL_KEY_STORE_PASSWORD=biztek
SOLR_SSL_TRUST_STORE=/var/solr/certs/biztek.co.id.jks
SOLR_SSL_TRUST_STORE_PASSWORD=biztek
