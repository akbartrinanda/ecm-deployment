  ...
  logging: {
    ...
    */
    ...
    consolecolor: {
      ...
      metrics: false,
      audit: false,
      handler: require("/home/centos/ecm-deployment/dev/apps/docmgt-nodered/src/logger_con.js")
    },
    ...
    file: {
      ...
      handler: require("/home/centos/ecm-deployment/dev/apps/docmgt-nodered/src/logger_file.js")
    },
    ...
    syslog: {
      ...
      handler: require("/home/centos/ecm-deployment/dev/apps/docmgt-nodered/src/logger_syslog.js")
    }
    */
  },
  ...
  */
  ...
  editorTheme: {
    page: {
      ...
      css: path.join('/home/centos/ecm-deployment/dev/apps/docmgt-nodered/src/css', 'custom.css'),
      scripts: path.join('/home/centos/ecm-deployment/dev/apps/docmgt-nodered/src/js', 'custom.js')  // As of 0.17
    },
    header: {
      title: "Documgt Workflow",
      // image: "/Users/khalifmv/TOP_SECRET/DEVELOPMENT/SDS/express/node-red-template-embedded/public/img.png", // or null to remove image
