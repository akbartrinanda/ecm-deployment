...
(function (global, factory) {
    ...
    */
    ...
    function createElement(options) {
        ...
        if (options.child)
            elem.appendChild(options.child); // Insert before
    ...
    function wrap(element, _ref) {
        var _ref$tag = _ref.tag, tag = _ref$tag === void 0 ? 'div' : _ref$tag, className = _ref.className, id = _ref.id, style = _ref.style;
    ...
    function () {
        function Slider(container, _ref) {
            var _this = this;
            var _onStart = _ref.onStart, _onMove = _ref.onMove, onEnd = _ref.onEnd, isSliderEnabled = _ref.isSliderEnabled;
            _classCallCheck(this, Slider);
            _defineProperty(this, "startHandler", function (eStart) {
                if (!_this.isSliderEnabled())
                    return;
                _this.removeListeners();
                eStart.preventDefault();
                var moveHandler = _this.moveHandler, endHandler = _this.endHandler, onStart = _this.onStart;
            ...
            _defineProperty(this, "moveHandler", function (eMove) {
                ...
                var sx = _this.sx, sy = _this.sy, onMove = _this.onMove;
    ...
    function () {
        function ImageViewer(element) {
            ...
            _defineProperty(this, "zoom", function (perc, point) {
                var _options = _this._options, _elements = _this._elements, _state = _this._state;
                var curPerc = _state.zoomValue, imageDim = _state.imageDim, containerDim = _state.containerDim, zoomSliderLength = _state.zoomSliderLength;
                var image = _elements.image, zoomHandle = _elements.zoomHandle;
            ...
            _defineProperty(this, "_clearFrames", function () {
                var _this$_frames = _this._frames, slideMomentumCheck = _this$_frames.slideMomentumCheck, sliderMomentumFrame = _this$_frames.sliderMomentumFrame, zoomFrame = _this$_frames.zoomFrame;
                clearInterval(slideMomentumCheck);
                cancelAnimationFrame(sliderMomentumFrame);
                cancelAnimationFrame(zoomFrame);
            });
            _defineProperty(this, "_resizeSnapHandle", function (imgWidth, imgHeight, imgLeft, imgTop) {
                var _elements = _this._elements, _state = _this._state;
                var snapHandle = _elements.snapHandle, image = _elements.image;
                var imageDim = _state.imageDim, containerDim = _state.containerDim, zoomValue = _state.zoomValue, snapImageDim = _state.snapImageDim;
            ...
            _defineProperty(this, "showSnapView", function (noTimeout) {
                var _this$_state = _this._state, snapViewVisible = _this$_state.snapViewVisible, zoomValue = _this$_state.zoomValue, loaded = _this$_state.loaded;
            ...
            var _this$_findContainerA = this._findContainerAndImageSrc(element, options), container = _this$_findContainerA.container, domElement = _this$_findContainerA.domElement, imageSrc = _this$_findContainerA.imageSrc, hiResImageSrc = _this$_findContainerA.hiResImageSrc; // containers for elements
            this._elements = {
                container: container,
        ...
        _createClass(ImageViewer, [{
                ...
                value: function _initImageSlider() {
                    ...
                    var imageSlider = new Slider(imageWrap, {
                        isSliderEnabled: function isSliderEnabled() {
                            var _this2$_state = _this2._state, loaded = _this2$_state.loaded, zooming = _this2$_state.zooming, zoomValue = _this2$_state.zoomValue;
                ...
                value: function _initSnapSlider() {
                    ...
                    var snapSlider = new Slider(snapHandle, {
                        ...
                        onStart: function onStart() {
                            var _this3$_frames = _this3._frames, slideMomentumCheck = _this3$_frames.slideMomentumCheck, sliderMomentumFrame = _this3$_frames.sliderMomentumFrame;
                        ...
                        onMove: function onMove(e, position) {
                            var _this3$_state = _this3._state, snapHandleDim = _this3$_state.snapHandleDim, snapImageDim = _this3$_state.snapImageDim;
                ...
                value: function _initZoomSlider() {
                    var _this4 = this;
                    var _this$_elements = this._elements, snapView = _this$_elements.snapView, zoomHandle = _this$_elements.zoomHandle; // zoom in zoom out using zoom handle
                ...
                value: function _snapViewEvents() {
                    var _this5 = this;
                    var _this$_elements2 = this._elements, imageWrap = _this$_elements2.imageWrap, snapView = _this$_elements2.snapView; // show snapView on mouse move
                ...
                value: function _pinchAndZoom() {
                    var _this6 = this;
                    var _this$_elements3 = this._elements, imageWrap = _this$_elements3.imageWrap, container = _this$_elements3.container; // apply pinch and zoom feature
                    var onPinchStart = function onPinchStart(eStart) {
                        var _this6$_state = _this6._state, loaded = _this6$_state.loaded, startZoomValue = _this6$_state.zoomValue;
                ...
                value: function _scrollZoom() {
                    ...
                    var _this$_elements4 = this._elements, container = _this$_elements4.container, imageWrap = _this$_elements4.imageWrap;
                    var changedDelta = 0;
                    var onMouseWheel = function onMouseWheel(e) {
                        var _this7$_state = _this7._state, loaded = _this7$_state.loaded, zoomValue = _this7$_state.zoomValue;
                        if (!_options.zoomOnMouseWheel || !loaded)
                            return; // clear all animation frame and interval
                ...
                value: function _getImageCurrentDim() {
                    var _this$_state2 = this._state, zoomValue = _this$_state2.zoomValue, imageDim = _this$_state2.imageDim;
                    return {
                ...
                value: function _loadImages() {
                    var _this9 = this;
                    var _images = this._images, _elements = this._elements;
                    var imageSrc = _images.imageSrc, hiResImageSrc = _images.hiResImageSrc;
                    var container = _elements.container, snapImageWrap = _elements.snapImageWrap, imageWrap = _elements.imageWrap;
                ...
                value: function _loadHighResImage(hiResImageSrc) {
                    var _this10 = this;
                    var _this$_elements5 = this._elements, imageWrap = _this$_elements5.imageWrap, container = _this$_elements5.container;
                ...
                value: function _calculateDimensions() {
                    var _this$_elements6 = this._elements, image = _this$_elements6.image, container = _this$_elements6.container, snapView = _this$_elements6.snapView, snapImage = _this$_elements6.snapImage, zoomHandle = _this$_elements6.zoomHandle; // calculate content width of image and snap image
                ...
                key: "destroy",
                value: function destroy() {
                    var _this$_elements7 = this._elements, container = _this$_elements7.container, domElement = _this$_elements7.domElement; // destroy all the sliders
                    Object.entries(this._sliders).forEach(function (_ref) {
                        var _ref2 = _slicedToArray(_ref, 2), key = _ref2[0], slider = _ref2[1];
                        slider.destroy();
                    }); // unbind all events
                    Object.entries(this._events).forEach(function (_ref3) {
                        var _ref4 = _slicedToArray(_ref3, 2), key = _ref4[0], unbindEvent = _ref4[1];
                        unbindEvent();
